...
global.owner = process.env.OWNER_NUMBER  || '94782019247' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "94782019247" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '10_07_2024_SIGMA_MD_gGktBM5s_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'LUKII-MD',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `LUKII`, // ADD YOUR NAME
